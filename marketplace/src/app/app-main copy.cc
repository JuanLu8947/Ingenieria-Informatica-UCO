    ...
    do{
        ...
        switch(op){
            ...
            case 3:{
                ...
                if(product_id == p1.GetId()){
                    ...
                    if(product_id == p.GetId())
                        m.AddProductClient(p, client_id);
                }      
                break;
            }
            case 4:{
                ...
                if(product_id == p1.GetId()){
                    ...
                    Product p(product_id);
                    if(product_id == p.GetId())
                        m.DeleteProductClient(p, client_id);
                } 
            ...
            case 7:
                ...
                break;
            case 8:{
                std::cout << "Estos son los vendedores existentes:\n";
                m.muestraV();
                std::cout << "Selecciona id de vendedor: ";
                std::cin >> seller_id;
                if(!m.muestraSeller(seller_id)){
                    std::cout << "ERROR. Este vendedor no existe\n";
                    break;
                }
                ...
                std::cout<<"Precio: ";
                std::cin>>price;
                std::cout<<"Fabricante de Producto: ";
                std::cin>>maker;
                Product p(product_id, name, price, maker, seller_id);
                if(!m.AddProductSeller(p, seller_id)){
                    std::cout<<"ERROR AL AÑADIR PRODUCTO "<<std::endl;
                }
                break;
            }
            default:
        ...
        switch(op){
            ...
            case 4:{
                ...
                std::cin >> product_id;
                Product p(product_id);
                if(!m.AddProductClient(p, client_id))
                    std::cout << "ERROR. Este producto no esta disponible\n";
            ...
            case 5:{
                ...
                std::cin >> product_id;
                Product p(product_id);
                if(!m.DeleteProductSeller(p, seller_id))
                    std::cout << "ERROR. Este producto no esta disponible\n";
